...
Thank you for considering contributing to the `al-qamous`! We appreciate your interest in helping us make this project better. Please take a moment to review these guidelines before submitting your contributions.
...
1. **Clone the Repository**:
   ...
   ```bash
   git clone https://github.com/al-arabiyya/al-qamous.git
   cd al-qamous
   ```
...
If you encounter a bug or have a feature request, please [open an issue](https://github.com/al-arabiyya/al-qamous/issues/new). When reporting:
...
By contributing to the `al-qamous`, you agree that your contributions will be licensed under the [MIT License](LICENSE).

## Support

For any questions or assistance, you can:

- Visit the [GitHub Discussions](https://github.com/al-arabiyya/al-qamous/discussions).
- Open an issue in the [Issues](https://github.com/al-arabiyya/al-qamous/issues) section.
