...
RUN cp -r ./al_qamous ./core

# Settings
RUN echo "'al_qamous'," >> core/settings.py
RUN echo "'al_qamous.apps.home'," >> core/settings.py
RUN echo "'al_qamous.cms'," >> core/settings.py
RUN echo "'al_qamous.ui'," >> core/settings.py
...
RUN echo "urlpatterns += [path('', include('al_qamous.ui.urls')), path('api/', include('al_qamous.api.urls')),]" >> core/urls.py
